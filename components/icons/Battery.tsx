...
const BatteryIcon = ({ battery }: { battery: number }) => {
    ...
    if (!mounted) return null // or a placeholder svg

    return (
        <svg width="26" height="13" viewBox="0 0 26 13" fill="none" id="svg-875191538_818">
            <g clipPath="url(#svg-875191538_818_clip0_58_1729)">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
            ...
            <defs>
                <clipPath id="svg-875191538_818_clip0_58_1729">
                    <rect width="25.5" height="12" fill="white" transform="translate(0 0.5)" />
                </clipPath>
            </defs>
        </svg>
    )
